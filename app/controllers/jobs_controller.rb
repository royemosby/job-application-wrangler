class JobsController < ApplicationController
  ...
  def job_params
    params.require(:job).permit(:title, :job_type, :company, :location, :is_remote, :status, :posting_url, :logo_url, :date_posted, :description, :notes, :user_id, :contact_id, :date_applied)
  end
end
